 ...
 */
public class FinishPointArea extends ObjectView {

    private Texture texture;

    public FinishPointArea(ObjectProperty objectProperty, Texture texture) {
    ...
    /*private void initialize(){
        ...
        pixmap.setColor(FinishPointArea.COLOR_FOR_THIS_OBJECT);
